...
const Privacy: React.FC = () => {
  ...
  VISAVSA, desenvolvido por IAM Tecnologia, pessoa jurídica de
        direito privado, devidamente inscrita no cnpj 37.940.405/0001-10, titular
        da propriedade intelectual sobre software, website, aplicativos,
        conteúdos e demais ativos relacionados à plataforma
        https://visavsa.iamtec.org/.
      </p>
      ...
      <p className="mb-4">
  A primeira providência para utilizar os Serviços do VISAVSA é
      ...
      <p className="mb-4">
      A plataforma coleta e armazena automaticamente algumas informações sobre a atividade dos Usuários cadastrados e visitantes de seu aplicativo/site. Tal informação pode incluir a URL de onde eles provêm; a que URL acessaram em seguida; o navegador que utilizam e seus IPs de acesso; as páginas visitadas; as buscas realizadas, dentre outras que poderão ser armazenadas e retidas.
      </p>

      <p className="mb-4">
      A plataforma poderá acessar as listas de contatos dos dispositivos móveis utilizados pelos usuários para fornecer seus Serviços. Essa informação somente será utilizada para localizar e marcar números de telefones celulares e/ou endereços de e-mails de potenciais usuários.
      </p>

      <p className="mb-4">
  Ficam cientes os Usuários de que seu perfil na plataforma estará acessível a todos demais Usuários e visitantes do VISAVSA. O VISAVSA coleta e armazena automaticamente algumas informações sobre a atividade dos Usuários cadastrados e visitantes de seu aplicativo/site. Tal informação pode incluir a URL de onde eles provêm; a que URL acessaram em seguida; o navegador que utilizam e seus IPs de acesso; as páginas visitadas; as buscas realizadas, dentre outras que poderão ser armazenadas e retidas.
      </p>
      ...
      <p className="mb-4">
        A plataforma observará todas as normas aplicáveis em matéria de medidas de
        segurança de Informação Pessoal. A plataforma considera os dados de seus
      ...
      <p className="mb-4">
        ...
        operações de forma ágil e segura, A plataforma requer certas informações
      ...
      <p className="mb-4">
      Uma vez registrado no Site, A plataforma não venderá, alugará ou compartilhará a Informação Pessoal, exceto nas formas estabelecidas nestas Políticas de privacidade. Será feito tudo o que estiver ao alcance no sentido de proteger a privacidade da Informação Pessoal.
      </p>
      ...
      <p className="mb-4">
        No geral, os fornecedores terceirizados usados pela plataforma irão
        ...
        <br/>
        Para esses fornecedores terceirizados, A plataforma aconselha aos Usuários que leiam as políticas de privacidade daqueles para que fique claro a maneira na qual as informações pessoais dos Usuários serão usadas por esses fornecedores terceirizados.
      </p>
      ...
      <p className="mb-4">
  A plataforma e os seus usuários não aceitam condutas consideradas &quot; spamming &quot;, seja em opiniões, perguntas, respostas e/ou no envio solicitado de e-mails ou no chat. Fica absolutamente proibido o envio indiscriminado de mensagens de qualquer natureza entre os usuários do VISAVSA
      </p>
      ...
      <p className="mb-4">
      A plataforma coopera com as autoridades competentes e com terceiros para garantir o cumprimento das leis, salvaguardar a integridade e a segurança do aplicativo/site e de seus Usuários, impedir atividades ilegais, por exemplo, em matéria de proteção de direitos de propriedade industrial e intelectual, prevenção a fraudes e outros.
      </p>
